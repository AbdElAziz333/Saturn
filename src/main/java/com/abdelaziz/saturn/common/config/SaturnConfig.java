...
public class SaturnConfig {
    ...
    public static class SaturnCommon {
        ...
        SaturnCommon(ForgeConfigSpec.Builder builder) {
            ...
            CLEAR_MEMORIES_LEAK_FIX = builder.comment("Set this to true to enable Ai clear memories leak fix.")
                    .define("clearMemoriesLeakFix", true);

            READ_RESOURCE_LEAK_FIX =
                    builder.comment("Set this to true to enable read resource leak fix.")
                            .define("readResourceLeakFix", true);
